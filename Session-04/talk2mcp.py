...
async def main():
    ...
    async with stdio_client(server_params) as (read, write):
        ...
        async with ClientSession(read, write) as session:
            ...
            system_prompt = f"""  
                You are a GitHub agent that executes GitHub-related actions iteratively. Your response must strictly follow 
                ...
                Where:  
                - `python_function_name` is one of the allowed functions.  
                - `input` is the argument required for that function.  
                - `[status]` is the final status of the task. 

                --- Start of Example ---
                FUNCTION_CALL: test_function|gender
                ...
                **Guidelines:**  
                - Respond with only ONE function call or final answer per iteration.  
                - Do not combine multiple responses in a single reply.  
            """
            ...
            query = f"Clone this repository '{url}', take a pull and add the code changes status to the Notes application, the status must be inside a Table"
            current_query = query  
